// Murray's FSM - Invoices Search & Filter Bar
// =============================================
...
export function InvoicesFilters({ currentStatus, currentSearch }: Props) {
  ...
  const hasFilters = currentSearch || (currentStatus && currentStatus !== 'all');
